...
editstyle = WebMS_JS_URL+'wyzz/wyzzstyles/editarea.css';

// Do we want to try to clean the code to emulate xhtml? 1=Yes, 0=No
xhtml_out = 1;

// Style Sheet
document.write('<link rel="stylesheet" type="text/css" href="'+ WebMS_JS_URL+'wyzz/wyzzstyles/style.css">\n');
...
function make_wyzz(textareaID) {
  ...
  for (btn in buttonName2) {
    ...
    if(buttonName2[btn] == "separator") {
      ...
      toolbar2 += '<td style="width: 22px;"><img src="'+WebMS_JS_URL+'wyzz/wyzzicons/' +buttonName2[btn]+ '.gif" border=0 unselectable="on" title="' +buttonName2[btn]+ '" id="' +buttonName2[btn]+ '" class="button" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button\'){className=\'buttonOver\'};" onmouseout="if(className==\'buttonOver\'){className=\'button\'};" unselectable="on" width="20" height="20"></td>';
      }
  }
  toolbar2 += '<td>&nbsp;</td></tr>';
...
// the foreground color picker
  ...
  toolbar2 += '<div id="colorpicker' + n + '" class="colorpicker" style="display:none">';
    ...
    toolbar2 += '<img class="closebutton" src="'+WebMS_JS_URL+'wyzz/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'colorpicker' + n + '\')"></div>';
  ...
  toolbar2 += '<img class="closebutton" src="'+WebMS_JS_URL+'wyzz/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'colorbackpicker' + n + '\')"></div>'; 
  // the font picker
  ...
  toolbar2 += '<img class="closebutton" src="'+WebMS_JS_URL+'wyzz/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'fontpicker' + n + '\')"></div>'; 
  ...
  toolbar2 += '</tr></table><br><img class="closebutton" src="'+WebMS_JS_URL+'wyzz/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'specialpicker' + n + '\')"></div>'; 
  // the header picker
  ...
  toolbar2 += '<img class="closebutton" src="'+WebMS_JS_URL+'wyzz/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'headerpicker' + n + '\')"></div>'; 
  ...
  toolbar2 += '<div class="help"><h4><img src="'+WebMS_JS_URL+'wyzz/wyzzicons/wyzzicon.gif" align="middle">Wyzz v' + version + '</h4><br>&copy; 2007 <a href="http://www.wyzz.info" target=_blank>www.wyzz.info</a><br><br></div>';
  toolbar2 += '<img class="closebutton" src="'+WebMS_JS_URL+'wyzz/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'helpbox' + n + '\')"></div></td></tr></table>';   
