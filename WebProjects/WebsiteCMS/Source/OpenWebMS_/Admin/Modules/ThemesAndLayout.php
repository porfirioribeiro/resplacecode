...
//Create the class
class ThemesAndLayout extends Module {
	function ThemesAndLayout($page){
		parent::Module($page);
	...
	function content(){
		...
		?>
		Below you can change various options concerning the themes and layout of WebMS.
		<?php
	}	
}
	
//create the class
class DefaultTheme extends Module {
...
//create the class
class ThemeLogo extends Module {
	function ThemeLogo($page){
		parent::Module($page);
	...
	function content(){
		...
		?>
			<br><br>
			<div class="fieldset">
			<div class="ftitle"><b>Logo Preview:</b></div><br>
