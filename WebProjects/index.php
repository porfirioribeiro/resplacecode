...
include_once("AutoSys/config.php");
define("WEBMS_ROOT","AutoSys/");
...
if ($WebMS["URLFormat"]=="CleanDots") {
	...
	if ($WebMS["URLParts"]==0 || $WebMS["URLArray"][0]=="") {
		...
		if ($WebMS["URLArray"][0]=="Admin") {
			...
			$p= new WebMS("AutoSys/","Error, Page not found!!");
