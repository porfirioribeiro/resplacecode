...
class WebMS{
	...
	var $devMode=false;
	var $title="";
	var $content_type="text/html; charset=western";
	var $favicon="favicon.ico";
	var $description="FFAuto, Encontre o seu carro online";
	var $keywords="FFAuto, auto, carros, usados, mercedes, opel";
	var $id="";
	var $root="";
	var $absRoot="";
